...
describe('<CardsList />', () => {
  it('should render the cards list', () => {
    ...
    expect(screen.getByRole('img', { name: /visa/i })).toHaveAttribute('src', '/img/visa.png')
    expect(screen.getByRole('img', { name: /master-card/i })).toHaveAttribute('src', '/img/master-card.png')
